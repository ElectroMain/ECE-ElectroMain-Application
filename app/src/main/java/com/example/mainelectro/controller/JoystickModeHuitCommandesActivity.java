...
public class JoystickModeHuitCommandesActivity extends AppCompatActivity {
    ...
    private AppCompatButton buttonPositionUpLeft;
    private AppCompatButton buttonPositionDownLeft;
    private AppCompatButton buttonPositionUpRight;
    private AppCompatButton buttonPositionDownRight;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_joystick_mode_huit_commandes);
        ...
        buttonPositionUpLeft = findViewById(R.id.buttonPositionUpLeft);
        buttonPositionDownLeft = findViewById(R.id.buttonPositionDownLeft);
        buttonPositionUpRight = findViewById(R.id.buttonPositionUpRight);
        buttonPositionDownRight = findViewById(R.id.buttonPositionDownRight);
        ...
        buttonBluetoothSettings.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent bluetoothActivity = new Intent(JoystickModeHuitCommandesActivity.this, Bluetooth1Activity.class);
        ...
        buttonPositionUpLeft.setOnTouchListener(new View.OnTouchListener() {
            @Override
            public boolean onTouch(View view, MotionEvent event) {
                if(event.getAction() == MotionEvent.ACTION_DOWN){
                    buttonPositionUpLeft.setBackgroundColor(Color.parseColor("#E3B926"));
                    if ( bluetoothClient == null ) return false;
                    if(isModeLego3DChecked){
                        code = '7';
                    }else{
                ...
                if(event.getAction() == MotionEvent.ACTION_UP){
                    buttonPositionUpLeft.setBackgroundColor(Color.parseColor("#6FB1E0"));
                    if ( bluetoothClient == null ) return false;
                    code = '0';
                    bluetoothClient.writeInt( code );
                    textViewSendValue.setText(String.valueOf(code-correctionCode));
        ...
        buttonPositionUpRight.setOnTouchListener(new View.OnTouchListener() {
            @Override
            public boolean onTouch(View view, MotionEvent event) {
                if(event.getAction() == MotionEvent.ACTION_DOWN){
                    buttonPositionUpRight.setBackgroundColor(Color.parseColor("#E3B926"));
                    if ( bluetoothClient == null ) return false;
                    if(isModeLego3DChecked){
                        code = '8';
                    }else{
                ...
                if(event.getAction() == MotionEvent.ACTION_UP){
                    buttonPositionUpRight.setBackgroundColor(Color.parseColor("#6FB1E0"));
                    if ( bluetoothClient == null ) return false;
                    code = '0';
                    bluetoothClient.writeInt( code );
                    textViewSendValue.setText(String.valueOf(code-correctionCode));
        ...
        buttonPositionDownLeft.setOnTouchListener(new View.OnTouchListener() {
            @Override
            public boolean onTouch(View view, MotionEvent event) {
                if(event.getAction() == MotionEvent.ACTION_DOWN){
                    buttonPositionDownLeft.setBackgroundColor(Color.parseColor("#E3B926"));
                    if ( bluetoothClient == null ) return false;
                    if(isModeLego3DChecked){
                        code = '5';
                    }else{
                ...
                if(event.getAction() == MotionEvent.ACTION_UP){
                    buttonPositionDownLeft.setBackgroundColor(Color.parseColor("#6FB1E0"));
                    if ( bluetoothClient == null ) return false;
                    code = '0';
                    bluetoothClient.writeInt( code );
                    textViewSendValue.setText(String.valueOf(code-correctionCode));
        ...
        buttonPositionDownRight.setOnTouchListener(new View.OnTouchListener() {
            @Override
            public boolean onTouch(View view, MotionEvent event) {
                if(event.getAction() == MotionEvent.ACTION_DOWN){
                    buttonPositionDownRight.setBackgroundColor(Color.parseColor("#E3B926"));
                    if ( bluetoothClient == null ) return false;
                    if(isModeLego3DChecked){
                        code = '6';
                    }else{
                ...
                if(event.getAction() == MotionEvent.ACTION_UP){
                    buttonPositionDownRight.setBackgroundColor(Color.parseColor("#6FB1E0"));
                    if ( bluetoothClient == null ) return false;
                    code = '0';
                    bluetoothClient.writeInt( code );
                    textViewSendValue.setText(String.valueOf(code-correctionCode));
